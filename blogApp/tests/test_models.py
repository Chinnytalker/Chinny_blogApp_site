...
from blogApp.models import Category, Post, Comment, Privacy
...
def test_privacy_model():
    # Assuming Privacy has a 'privacy_level' field
    privacy = Privacy.objects.create(privacy="Public")

    # Test privacy instance creation
    assert privacy.privacy == "Public"
    assert str(privacy) == "Public"  # Assuming _str_ returns privacy_level
